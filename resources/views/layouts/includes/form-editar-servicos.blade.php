...
<form action="@if(count($profile->servicos) != 0){{route('post-editar-servicos')}}@else{{route('post-cadastrar-servicos')}}@endif" method="POST">
  ...
  @forelse($profile->categorias as $categoria)
    ...
    <div class="row placeholder">
      <h3 class="cyan-third">{{$categoria->name}}</h3>
      <hr style="border-color: #024D62; opacity: 0.3;">
