...
@section('title') Editar Especialidades - Facilite Serviços @endsection
...
@section('content')
  ...
  <div style="box-shadow: 0px 2px 4px #888888" class="col-sm-4 col-md-3 col-lg-2 sidebar">
    ...
    @else
      ...
      <hr>
      <div>
        <span style="font-size: 20px;" class="cyan-third"><b>4) Especialidades</b></span>
      ...
      <div class="progress" style="margin-top: 0%">
        <div class="progress-bar progress-bar-success" style="width: 60%; background-color: #5BB400;">
          <span>3 de 5</span>
        </div>
      </div>
  ...
  <div style="background-color: #FFFFFF; border: 1px solid #ECECEC;" class="col-sm-8 col-sm-offset-4 col-md-9 col-md-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    @if(count($profile->especialidades) != 0)
      <h1 class="page-header green-third">Editar especialidades</h1>
    @else
      <h1 class="page-header green-third">Cadastrar especialidades</h1>
    @endif
    ...
    <div {{-- style="background-color: white; box-shadow: 0px 0px 1px #AEAEAE;" --}} class="row placeholders">
      ...
      {{-- FORM EDITAR ESPECIALIDADES --}}
      @include('layouts.includes.form-editar-especialidades')
