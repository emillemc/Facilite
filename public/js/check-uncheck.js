 ...
 */
 $( document ).ready(function() {
    ...
    // cat_2
    $("#check_span_2, #label_cat_2").on("click", function() {
        if( $("#cat_2").is(":checked") ){
    ...
    // cat_3
    $("#check_span_3, #label_cat_3").on("click", function() {
        if( $("#cat_3").is(":checked") ){
    ...
    // cat_4
    $("#check_span_4, #label_cat_4").on("click", function() {
        if( $("#cat_4").is(":checked") ){
    ...
    // cat_5
    $("#check_span_5, #label_cat_5").on("click", function() {
        if( $("#cat_5").is(":checked") ){
    ...
    // cat_6
    $("#check_span_6, #label_cat_6").on("click", function() {
        if( $("#cat_6").is(":checked") ){
